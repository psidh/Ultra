...
function Begin() {
  ...
  return (
    <div className="bg-[#970CDA] text-white">
      ...
      <h2 className="text-5xl lg:text-8xl font-semibold pb-16 px-16 border-b-[1px] border-black">
        of ULTRA
      </h2>
      <div className=" p-4 pb-16 px-16 flex md:flex-row flex-col-reverse justify-center md:justify-between w-full md:space-x-16 font-thin border-b-[1px] border-black">
        <div className="w-full md:w-2/3 flex flex-col mt-4 items-start text-justify md:text-left">
          ...
          <button
            onClick={handleClick}
            className="font-medium text-xl flex gap-4 items-center px-12 py-5 border-none hover:bg-green-500 bg-[rgb(10,20,57)] rounded-full"
          >
